...
import com.example.xy.hellowolrd.MainActivity;
import com.example.xy.hellowolrd.MyErrorQuestionActivity;
import com.example.xy.hellowolrd.R;
...
public class ExaminationSubmitAdapter extends PagerAdapter {
    ...
    public ExaminationSubmitAdapter(MainActivity context, List<View> viewItems, List<AnSwerInfo> dataItems,String imgServerUrl) {
        mContext = context;
